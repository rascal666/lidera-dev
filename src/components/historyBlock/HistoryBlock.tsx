...
import img0 from '../../assets/img/history/general.png'
        ...
        <div className='history' >
            <div className="history__content">
                <div  className='history__info'>
                    ...
                    <div className="history__images history__images-mobile">
                        <img className='history__images' src={img0} alt=""/>
                ...
                <div className="history__images history__images-desktop">
